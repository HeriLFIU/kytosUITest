...
// Options for module testing
// Note: all calls to load module should preferably use a single set of options to mantain a cache
// const options = {
...
// Test output and module loading
//kytos.component('test', defineAsyncComponent( () => loadModule("http://localhost:8181/ui/kytos/maintenance/k-toolbar/main.kytos", options) ))
// console.log(loadModule("http://localhost:8181/ui/kytos/maintenance/k-toolbar/main.kytos", options))
// console.log(defineAsyncComponent( () => loadModule("http://localhost:8181/ui/kytos/maintenance/k-toolbar/main.kytos", options) ))

// console.log(kytos._context.components)

// Preserve extra whitespaces
kytos.config.compilerOptions.whitespace = 'preserve';

// Test output
// console.log(window.kytos_server)
// console.log(window.kytos_server_api)
...
// Test new kytos_server and api global variables
// console.log(kytos.config.globalProperties.$kytos_server)
// console.log(kytos.config.globalProperties.$kytos_server_api)
